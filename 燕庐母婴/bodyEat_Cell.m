...
//
        ...
        self.xian.backgroundColor=RGBA(201, 201, 201, 1);
        //self.xian.layer.borderColor=RGBA(201, 201, 201, 1).CGColor;
        ...
        [self.contentView addConstraint:[NSLayoutConstraint constraintWithItem:self.xian
                                                                     ...
                                                                     attribute:NSLayoutAttributeWidth
                                                                    multiplier:1
                                                                      constant:self.contentView.frame.size.width-65]];
        [self.contentView addConstraint:[NSLayoutConstraint constraintWithItem:self.xian
                                                                     attribute:NSLayoutAttributeHeight
                                                                     relatedBy:NSLayoutRelationEqual
                                                                        toItem:self.contentView
...
//- (void)drawRect:(CGRect)rect isstring:(NSString *)string
//{
//    
//    
